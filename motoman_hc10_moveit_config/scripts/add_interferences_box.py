...
class MoveGroupPythonIntefaceTutorial(object):
  ...
  def add_interferences(self, timeout=4):
    ...
    yBloc = [[-150, 150], [-990, 1150], [200, 1150], [-990, -200], [-990, 1150], [900, 1150], [800, 810], [-610, -600], [-600, 800], [-600, 800], [160, 1060]]
    xBloc = [[-350, -200], [-1530, -860], [-1530, 860], [-1530, 860], [200, 860], [-270, -50], [-600, 1000], [-600, 1000], [-610, -600], [1000, 1010], [160, 860]]

    zBloc = [[-500, -150], [-500, 1530], [-500, -300], [-500, -300], [-500, -300], [-500, 1350], [-750, 2000],[-750, 2000], [-750, 2000], [-750, 2000], [-300, -200]]
